...
export function MainTabs({ householdId, onLogout }: { householdId: string; onLogout: () => void }) {
  return (
    <Tab.Navigator>
      <Tab.Screen name="Einkaufsliste">{() => <ShoppingListScreen householdId={householdId} />}</Tab.Screen>
